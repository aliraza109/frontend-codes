...
function clearForm(){
    ...
    $.ajax({
        url:'http://192.168.1.104:8081/api/v1/create-contact',
        dataType:'json',
        type: 'post',
        ...
        success: function( data, textStatus, jQxhr ){
            ...
            getContactBookFromServer();
                },
        error: function( jqXhr, textStatus, errorThrown ){
       alert('Something went wrong while creating contact');
        }
    });
    ...
    function renderContactBook(){
     ...
     function getContactBookFromServer(){
        $.ajax({
            url:'http://192.168.1.104:8081/api/v1/contact-book',
            type: 'get',
            success: function( data, textStatus, jQxhr ){
                contactBook=data
                renderContactBook()
            ...
            error: function( jqXhr, textStatus, errorThrown ){
           alert('Something went wrong while getting contactbook');
            }
        });
     }
